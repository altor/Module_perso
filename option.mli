...
val double_bind : 'a option -> 'b option -> ('a -> ('b -> 'c) option) -> 'c option

(** [bindable f] transforme une fonction de type ['a -> 'b] en fonction de type ['a -> 'b option ] *)
val bindable : ('a -> 'b) -> 'a -> 'b option
